...
public class GenYggdrasillTree extends WorldGenAbstractTree {
    ...
    /*原木*/
    private IBlockState LOG = OHRBlocks.LOG_YGGDRASILL.getDefaultState();
    /*树叶,枯萎检查false,枯萎false*/
    private IBlockState LEAF = OHRBlocks.LEAF_YGGDRASILL.getDefaultState();

    public GenYggdrasillTree(boolean notify) {
        super(notify);
    }
...
*/
    public GenYggdrasillTree setTreeScale(float height, float width, float leaves) {
    ...
    public GenYggdrasillTree setMinTrunkSize(int radius) {

        trunkSize = Math.max(radius, trunkSize);
        return this;
    }

    public GenYggdrasillTree setLeafAttenuation(float a) {
        heightAttenuation = a;
        return this;
    }

    public GenYggdrasillTree setSloped(boolean s) {
        slopeTrunk = s;
        return this;
    }

    public GenYggdrasillTree setSafe(boolean s) {
        safeGrowth = s;
        return this;
    }
    ...
    public boolean generate(World world, Random par2Random, BlockPos pos) {
        ...
        if (!this.validTreeLocation())
            ...
            OceanHeartR.getLogger().info("验证世界树生成位置: " + time + "ns");
            ...
            time = System.nanoTime() - time;
            OceanHeartR.getLogger().info("生成世界树: " + time + "ns");
            trunk -= bases;
            bases -= leaves;
            leaves -= nodes;
            nodes -= time2;
            OceanHeartR.getLogger().info(String.format("%s 主干, %s 树叶节点, %s 树叶, %s 树枝", trunk, nodes, leaves, bases));
            OceanHeartR.getLogger().info("\t包含 " + blocksAdded + " 方块");
